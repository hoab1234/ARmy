...
public enum AndroidPermission2
{
...
public class AndroidUtils : MonoBehaviour
{
    ...
    {
#if UNITY_ANDROID && !UNITY_EDITOR
        if (!AndroidUtils.IsPermitted(AndroidPermission2.RECORD_AUDIO))//RECORD_AUDIO is declared inside plugin manifest but we need to request it manualy
        {
            AndroidUtils.RequestPermission(AndroidPermission2.RECORD_AUDIO);
            onAllowCallback = () =>
            {
    ...
    public static bool IsPermitted(AndroidPermission2 permission)
    {
#if UNITY_ANDROID && !UNITY_EDITOR
    ...
    public static void RequestPermission(AndroidPermission2 permission, UnityAction onAllow = null, UnityAction onDeny = null, UnityAction onDenyAndNeverAskAgain = null)
    {
#if UNITY_ANDROID && !UNITY_EDITOR
    ...
    private static string GetPermissionStrr(AndroidPermission2 permission)
    {
